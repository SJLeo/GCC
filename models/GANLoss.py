...
class PerceptualLoss(nn.Module):
    ...
    def forward(self, fake_high_resolution, high_resolution):
        perception_loss = self.mse_loss(self.loss_network(fake_high_resolution), self.loss_network(high_resolution))
...
class TruncatedVGG19(nn.Module):
    ...
    def __init__(self, i, j):
        ...
        self.truncated_vgg19 = nn.Sequential(*list(vgg.features.children())[:truncate_at + 1])
